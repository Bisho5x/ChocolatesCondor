            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#commentModal-<?php echo $post['post_id']; ?>">
                            Comentarios
                        </button>
                    </div>
                </div>
...
<?php foreach ($posts as $post): ?>
    <div class="modal fade" id="commentModal-<?php echo $post['post_id']; ?>" tabindex="-1" aria-labelledby="commentModalLabel-<?php echo $post['post_id']; ?>" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    $sql = "SELECT comments.content, users.username, users.user_id
                                      FROM comments
